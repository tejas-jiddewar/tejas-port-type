      ...
      <footer className="bg-card border-t border-border py-12">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid md:grid-cols-3 gap-8">
            <div>
              <div className="text-3xl font-orbitron font-bold gradient-text mb-4">
                Tejas Jiddewar
              </div>
              <p className="text-muted-foreground mb-6">
                Transforming data into actionable insights through advanced analytics and intelligent solutions.
              </p>
              <div className="flex space-x-4">
                <a href="#" className="w-10 h-10 bg-muted rounded-full flex items-center justify-center hover:bg-primary hover:text-primary-foreground transition-colors duration-300">
          ...
          <div className="border-t border-border mt-8 pt-8 text-center">
            <p className="text-muted-foreground">
              © 2024 Tejas Jiddewar. All rights reserved. Designed with innovation and precision.
            </p>
          </div>
        </div>
      </footer>
